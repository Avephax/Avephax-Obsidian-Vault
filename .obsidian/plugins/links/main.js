...
var ConvertLinkToHtmllinkCommand = class extends CommandBase {
  ...
  convertLinkToHtmllink(linkData, editor) {
    var _a;
    if (((_a = linkData.link) == null ? void 0 : _a.content) && linkData.type === 2 /* Wiki */) {
  ...
  generateLinkText(linkData) {
    var _a, _b;
    if (!((_a = linkData.link) == null ? void 0 : _a.content)) {
    ...
    return getFileName((_b = linkData.link) == null ? void 0 : _b.content);
  }
};
